...
def active_vessel(conn) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "get_ActiveVessel") do
...
def set_active_vessel(conn, vessel_id) do
  Jooce.Client.call_rpc(conn, "SpaceCenter", "set_ActiveVessel", [{vessel_id, :uint64, nil}])
end
...
def launchable_vessels(conn, craft_directory \\ "VAB") do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "LaunchableVessels", [{craft_directory, :string, nil}]) do
    {:ok, return_value, time} ->
...
def autopilot_engage(conn, autopilot_id) do
  Jooce.Client.call_rpc(conn, "SpaceCenter", "AutoPilot_Engage", [{autopilot_id, :uint64, nil}])
end
...
def autopilot_disengage(conn, autopilot_id) do
  Jooce.Client.call_rpc(conn, "SpaceCenter", "AutoPilot_Disengage", [{autopilot_id, :uint64, nil}])
end
...
def autopilot_get_target_pitch(conn, autopilot_id) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "AutoPilot_get_TargetPitch", [{autopilot_id, :uint64, nil}]) do
    {:ok, return_value, time} ->
...
def autopilot_set_target_pitch(conn, autopilot_id, value) do
  Jooce.Client.call_rpc(conn, "SpaceCenter", "AutoPilot_set_TargetPitch", [{autopilot_id, :uint64, nil}, {value, :float, nil}])
end
...
def autopilot_get_target_heading(conn, autopilot_id) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "AutoPilot_get_TargetHeading", [{autopilot_id, :uint64, nil}]) do
    {:ok, return_value, time} ->
...
def autopilot_set_target_heading(conn, autopilot_id, value) do
  Jooce.Client.call_rpc(conn, "SpaceCenter", "AutoPilot_set_TargetHeading", [{autopilot_id, :uint64, nil}, {value, :float, nil}])
end
...
def autopilot_get_sas(conn, autopilot_id) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "AutoPilot_get_SAS", [{autopilot_id, :uint64, nil}]) do
    {:ok, return_value, time} ->
...
def autopilot_set_sas(conn, autopilot_id, value) do
  Jooce.Client.call_rpc(conn, "SpaceCenter", "AutoPilot_set_SAS", [{autopilot_id, :uint64, nil}, {value, :bool, nil}])
end
...
def autopilot_get_sas_mode(conn, autopilot_id) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "AutoPilot_get_SASMode", [{autopilot_id, :uint64, nil}]) do
    {:ok, return_value, time} ->
...
def autopilot_set_sas_mode(conn, autopilot_id, value) do
  Jooce.Client.call_rpc(conn, "SpaceCenter", "AutoPilot_set_SASMode", [{autopilot_id, :uint64, nil}, {value, :int32, nil}])
end
...
def control_activate_next_stage(conn, control_id) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "Control_ActivateNextStage", [{control_id, :uint64, nil}]) do
    {:ok, return_value, time} ->
...
def control_get_throttle(conn, control_id) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "Control_get_Throttle", [{control_id, :uint64, nil}]) do
    {:ok, return_value, time} ->
...
def control_set_throttle(conn, control_id, value) do
  Jooce.Client.call_rpc(conn, "SpaceCenter", "Control_set_Throttle", [{control_id, :uint64, nil}, {value, :float, nil}])
end
...
def flight_get_mean_altitude(conn, flight_id) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "Flight_get_MeanAltitude", [{flight_id, :uint64, nil}]) do
    {:ok, return_value, time} ->
...
def flight_get_surface_altitude(conn, flight_id) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "Flight_get_SurfaceAltitude", [{flight_id, :uint64, nil}]) do
    {:ok, return_value, time} ->
      {altitude, _} = :gpb.decode_type(:double, return_value, nil)
      {:ok, altitude, time}
    {:error, _reason, _time} = error ->
...
def flight_get_bedrock_altitude(conn, flight_id) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "Flight_get_BedrockAltitude", [{flight_id, :uint64, nil}]) do
    {:ok, return_value, time} ->
      {altitude, _} = :gpb.decode_type(:double, return_value, nil)
      {:ok, altitude, time}
    {:error, _reason, _time} = error ->
...
def resources_amount(conn, resources_id, name) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "Resources_Amount", [{resources_id, :uint64, nil}, {name, :string, nil}]) do
    {:ok, return_value, time} ->
...
def vessel_get_flight(conn, vessel_id) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "Vessel_Flight", [{vessel_id, :uint64, nil}]) do
    {:ok, return_value, time} ->
...
def vessel_get_control(conn, vessel_id) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "Vessel_get_Control", [{vessel_id, :uint64, nil}]) do
    {:ok, return_value, time} ->
...
def vessel_get_autopilot(conn, vessel_id) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "Vessel_get_AutoPilot", [{vessel_id, :uint64, nil}]) do
    {:ok, return_value, time} ->
...
def vessel_get_resources(conn, vessel_id) do
  case Jooce.Client.call_rpc(conn, "SpaceCenter", "Vessel_get_Resources", [{vessel_id, :uint64, nil}]) do
    {:ok, return_value, time} ->
